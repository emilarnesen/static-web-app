...
import mobildamehode from '../images/mobildamehode.png';

import espenkjolberg from '../images/espenkjolberg.png';
import nilsbredemoe from '../images/nilsbredemoe.png';
import josteinemmerhoff from '../images/josteinemmerhoff.jpeg';
import idaaalen from '../images/idaaalen.jpg';
import martesolheim from '../images/martesolheim.jpeg';
import ingebjorgfoss from '../images/ingebjorgfoss.jpeg';
    ...
    <Layout>
      ...
      <section className="smud-page smud-page--1" id="page-1">
        <div className="smud-page__container">
          ...
          <div className="smud-c2a">
            <Link to="#page-3" className="smud-c2a__button">
              Se programmet
            </Link>
          </div>
        </div>
      ...
      <main>
        <section className="smud-page smud-page--3 smud-program" id="page-3">
          <div className="smud-page__container">
            <h2 className="smud-h2">Historiene bak gode, brukervennlige produkter som kundene elsker og som skaper forretningsverdi</h2>
            <div className="smud-talks-container">
              <div className="smud-talks">
                <h3 className="smud-h3">Del 1 - Organisasjon og ledelse</h3>
                <ul className="smud-talks__list">
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">09.00</span>
                      <span className="smud-talks__time-end">09.05</span>
                    </div>
                    <div className="smud-talks__talk smud-talks__talk--intro">
                      <div className="smud-talks__speaker-image">
                        &nbsp;
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Introduksjon</h4>
                        <p className="smud-talks__speaker-name">Thomas Allan Nygaard</p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">09.05</span>
                      <span className="smud-talks__time-end">09.25</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                        <img src={espenkjolberg} alt="Espen Kjølberg" />
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Kunngjøres snart</h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name">Espen Kjølberg</p>
                        <p className="smud-talks__speaker-title">Administrerende direktør</p>
                        <p className="smud-talks__speaker-company">SpareBank 1 Utvikling</p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">09.30</span>
                      <span className="smud-talks__time-end">09.50</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                      ...
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Hvordan bygge en nordisk produktorganisasjon</h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name">Jostein Emmerhoff</p>
                        <p className="smud-talks__speaker-title">Agile Delivery Director</p>
                        <p className="smud-talks__speaker-company">Schibsted Nordic Marketplaces</p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">09.55</span>
                      <span className="smud-talks__time-end">10.15</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                      ...
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title"></h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name">Nils Brede Moe</p>
                        <p className="smud-talks__speaker-title">Sjefforsker</p>
                        <p className="smud-talks__speaker-company">Sintef</p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">10.15</span>
                      <span className="smud-talks__time-end">10.30</span>
                    </div>
                    <div className="smud-talks__talk smud-talks__talk--pause">
                      <div className="smud-talks__speaker-image">
                        &nbsp;
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Pause</h4>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">10.30</span>
                      <span className="smud-talks__time-end">11.00</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                        <img src={idaaalen} alt="Ida Aalen"/>
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">OKRer</h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name">Ida Aalen</p>
                        <p className="smud-talks__speaker-title">Produktcoach</p>
                        <p className="smud-talks__speaker-company">Selvstendig konsulent</p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">11.00</span>
                      <span className="smud-talks__time-end">12.00</span>
                    </div>
                    <div className="smud-talks__talk smud-talks__talk--pause">
                      <div className="smud-talks__speaker-image">
                        &nbsp;
                      ...
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Lunsj</h4>
                      </div>
                    </div>
                  </li>
                </ul>
              </div>
              <div className="smud-talks smud-talks--part-2">
                <h3 className="smud-h3">Del 2 - Hvordan bygge produkter som kundene elsker</h3>
                <ul className="smud-talks__list">
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">12.00</span>
                      <span className="smud-talks__time-end">12.20</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                        <img src={martesolheim} alt="Marte Solheim" />
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Mangfold og innivasjon</h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name">Marte Solheim</p>
                        <p className="smud-talks__speaker-title"></p>
                        <p className="smud-talks__speaker-company"></p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">12.30</span>
                      <span className="smud-talks__time-end">12.50</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                        <img src={ingebjorgfoss} alt="Ingebjørg Foss Daae" />
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title"></h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name">Ingebjørg Foss Daae</p>
                        <p className="smud-talks__speaker-title">COO</p>
                        <p className="smud-talks__speaker-company">Consigli</p>
                      </div>
                    </div>
                  </li>
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">13.20</span>
                      <span className="smud-talks__time-end">13.50</span>
                    </div>
                    <div className="smud-talks__talk">
                      <div className="smud-talks__speaker-image">
                        <img src={mobildamehode} alt="" />
                      </div>
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Kunngjøres snart</h4>
                        <p className="smud-talks__talk-brief"></p>
                        <p className="smud-talks__speaker-name"></p>
                        <p className="smud-talks__speaker-title"></p>
                        <p className="smud-talks__speaker-company"></p>
                      </div>
                    </div>
                  ...
                  <li className="smud-talks__item">
                    <div className="smud-talks__time">
                      <span className="smud-talks__time-start">14.20</span>
                    </div>
                    <div className="smud-talks__talk smud-talks__talk--intro">
                      <div className="smud-talks__speaker-image">
                        &nbsp;
                      ...
                      <div className="smud-talks__talk-info">
                        <h4 className="smud-talks__talk-title">Avrunding og oppsummering</h4>
                        <p className="smud-talks__speaker-name">Thomas Allan Nygaard</p>
                      </div>
                    </div>
                  </li>
            ...
            <img src={phone} className="smud-illustration smud-illustration--phone" alt="" />
          </div>
        </section>
        ...
        <section className="smud-page smud-page--4" id="page-4">
          <div className="smud-page__container">
            ...
            <h3 className="smud-h3 smud-holdthedate">
                    <span>
                        NB! Påmeldingen fungerer pt. ikke for alle bankene (bl.a. SR-Bank).
                    </span>
            </h3>
            <a href="https://forms.office.com/e/1bcfzHUd7q" className="smud-register">
              Påmelding
            </a>
